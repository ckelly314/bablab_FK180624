...
'''
Cox1 = round(4-4*(rAOU.params[1]-2*rN.params[1])/rC.params[1],2) # Cox with nitrification = 4 - 4*(AOU:P - N:P)/C:P
Cox2 = round(4-4*(rAOU.params[1])/rC.params[1],2) # Cox with no nitrification = 4 - 4*AOU:P/C:P
